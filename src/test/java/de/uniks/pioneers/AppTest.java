...
class AppTest extends ApplicationTest {
    ...
    test() {
        ...
        TestModule.gamePlayerSubject.onNext(new Event<>(".updated", new Player("000","002","#0000ff", true,3, new Resources(0,2,0,0,1,1), new RemainingBuildings(3,4,13), 2, 0)));
        TestModule.gamePlayerSubject.onNext(new Event<>(".updated", new Player("000","000","#ff0000", true,3, new Resources(0,1,3,3,2,2), new RemainingBuildings(3,4,13), 2, 0)));
