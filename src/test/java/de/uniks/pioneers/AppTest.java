...
class AppTest extends ApplicationTest {
    ...
    test() throws TimeoutException {
        ...
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "1", "000", "001", FOUNDING_ROLL, 4, null, null, null, null, null)));
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove[]{new ExpectedMove(FOUNDING_ROLL, List.of(new String[]{"002", "003"}))}), null)));
        sleep(1000);
        ...
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "2", "000", "002", FOUNDING_ROLL, 5, null, null, null, null, null)));
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove[]{new ExpectedMove(FOUNDING_ROLL, List.of(new String[]{"003"}))}), null)));
        sleep(1000);
        ...
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "3", "000", "003", FOUNDING_ROLL, 6, null, null, null, null, null)));
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("000")), new ExpectedMove(FOUNDING_ROAD_1, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("002")), new ExpectedMove(FOUNDING_ROAD_1, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("003")), new ExpectedMove(FOUNDING_ROAD_1, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("001")), new ExpectedMove(FOUNDING_ROAD_1, List.of("001")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("003")), new ExpectedMove(FOUNDING_ROAD_2, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("002")), new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));
        sleep(1000);
        ...
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "4", "000", "000", FOUNDING_SETTLEMENT_1, 0, "1", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_ROAD_1, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("002")), new ExpectedMove(FOUNDING_ROAD_1, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("003")), new ExpectedMove(FOUNDING_ROAD_1, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("001")), new ExpectedMove(FOUNDING_ROAD_1, List.of("001")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("003")), new ExpectedMove(FOUNDING_ROAD_2, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("002")), new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("ME:\n" + "place road"));
        clickOn("#1,0,-1,7");
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(1, 0, -1, "2", 7, "road", "000", "000")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "5", "000", "000", FOUNDING_ROAD_1, 0, "2", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("002")), new ExpectedMove(FOUNDING_ROAD_1, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("003")), new ExpectedMove(FOUNDING_ROAD_1, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("001")), new ExpectedMove(FOUNDING_ROAD_1, List.of("001")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("003")), new ExpectedMove(FOUNDING_ROAD_2, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("002")), new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_002:\n" + "place settlement"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(-2, 1, 1, "3", 0, "settlement", "000", "002")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "6", "000", "002", FOUNDING_SETTLEMENT_1, 0, "3", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_ROAD_1, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("003")), new ExpectedMove(FOUNDING_ROAD_1, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("001")), new ExpectedMove(FOUNDING_ROAD_1, List.of("001")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("003")), new ExpectedMove(FOUNDING_ROAD_2, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("002")), new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_002:\n" + "place road"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(-1, 1, 0, "4", 7, "road", "000", "002")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "7", "000", "002", FOUNDING_ROAD_1, 0, "4", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("003")), new ExpectedMove(FOUNDING_ROAD_1, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("001")), new ExpectedMove(FOUNDING_ROAD_1, List.of("001")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("003")), new ExpectedMove(FOUNDING_ROAD_2, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("002")), new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_003:\n" + "place settlement"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(2, -1, -1, "5", 6, "settlement", "000", "003")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "8", "000", "003", FOUNDING_SETTLEMENT_1, 0, "5", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_ROAD_1, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("001")), new ExpectedMove(FOUNDING_ROAD_1, List.of("001")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("003")), new ExpectedMove(FOUNDING_ROAD_2, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("002")), new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_003:\n" + "place road"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(1, -1, 0, "6", 3, "road", "000", "003")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "9", "000", "003", FOUNDING_ROAD_1, 0, "6", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_SETTLEMENT_1, List.of("001")), new ExpectedMove(FOUNDING_ROAD_1, List.of("001")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("003")), new ExpectedMove(FOUNDING_ROAD_2, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("002")), new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_001:\n" + "place settlement"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(0, -1, 1, "7", 0, "settlement", "000", "001")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "10", "000", "001", FOUNDING_SETTLEMENT_1, 0, "7", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_ROAD_1, List.of("001")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("003")), new ExpectedMove(FOUNDING_ROAD_2, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("002")), new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_001:\n" + "place road"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(0, -1, 1, "8", 11, "road", "000", "001")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "11", "000", "001", FOUNDING_ROAD_1, 0, "8", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("003")), new ExpectedMove(FOUNDING_ROAD_2, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("002")), new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_003:\n" + "place settlement"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(0, 2, -2, "9", 6, "settlement", "000", "003")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "12", "000", "003", FOUNDING_SETTLEMENT_2, 0, "9", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_ROAD_2, List.of("003")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("002")), new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_003:\n" + "place road"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(-1, 2, -1, "10", 3, "road", "000", "003")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "13", "000", "003", FOUNDING_ROAD_2, 0, "10", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("002")), new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_002:\n" + "place settlement"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(-1, -1, 2, "11", 0, "settlement", "000", "002")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "14", "000", "002", FOUNDING_SETTLEMENT_2, 0, "11", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_ROAD_2, List.of("002")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_002:\n" + "place road"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(-1, -1, 2, "12", 11, "road", "000", "002")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "15", "000", "002", FOUNDING_ROAD_2, 0, "12", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("000")), new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("ME:\n" + "place settlement"));
        clickOn("#2,1,-3,6");
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(2, 1, -3, "13", 6, "settlement", "000", "000")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "16", "000", "000", FOUNDING_SETTLEMENT_2, 0, "13", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_ROAD_2, List.of("000")), new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));
        sleep(1500);
        ...
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "17", "000", "000", FOUNDING_ROAD_2, 0, "14", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_SETTLEMENT_2, List.of("001")), new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_001:\n" + "place settlement"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(3, -1, -2, "15", 6, "settlement", "000", "001")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "18", "000", "001", FOUNDING_SETTLEMENT_2, 0, "15", null, null, null, null)));
        ...
        TestModule.gameStateSubject.onNext(new Event<>(".updated", new State("2022-05-18T18:12:59.114Z", "000", List.of(new ExpectedMove(FOUNDING_ROAD_2, List.of("001")), new ExpectedMove(ROLL, List.of("003"))), null)));

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#situationLabel", LabeledMatchers.hasText("TestUser_001:\n" + "place road"));
        TestModule.gameBuildingSubject.onNext(new Event<>(".created", new Building(2, -1, -1, "16", 3, "road", "000", "001")));
        TestModule.gameMoveSubject.onNext(new Event<>(".created", new Move("2022-05-18T18:12:59.114Z", "19", "000", "001", FOUNDING_ROAD_2, 0, "16", null, null, null, null)));
