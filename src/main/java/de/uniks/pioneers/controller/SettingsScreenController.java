...
public class SettingsScreenController implements Controller, Initializable {
    ...
    public void setApperenceMode() {
        ...
        if (lightMode_RadioButton.isSelected()){
            ...
            ingameScreenController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobalDark)));
            ingameScreenController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobal, "/de/uniks/pioneers/styles/IngameScreen.css");
            ...
            newGameController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobalDark)));
            newGameController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobal,"/de/uniks/pioneers/styles/NewGameScreen.css");
            ...
            lobbyController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobalDark)));
            lobbyController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobal, "/de/uniks/pioneers/styles/LobbyScreen.css");
            chatController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobalDark)));
            chatController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobal);
            ...
            editController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobalDark)));
            editController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobal, "/de/uniks/pioneers/styles/EditProfileScreen.css");
            loginController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobalDark)));
            loginController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobal);
            ...
            rulesController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobalDark)));
            rulesController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobal, "/de/uniks/pioneers/styles/RulesScreen.css");
            ...
            userListController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobalDark)));
            userListController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobal, "/de/uniks/pioneers/styles/UserListView.css");
            gameListController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobalDark)));
            gameListController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobal);
            stage.getScene().getStylesheets().removeIf((style -> style.equals("/de/uniks/pioneers/styles/DarkMode_SettingsScreen.css")));
            stage.getScene().getStylesheets().removeIf((style -> style.equals(styleGlobalDark)));
            stage.getScene().getStylesheets().addAll(styleGlobal, "/de/uniks/pioneers/styles/SettingsScreen.css");
        }
        if(darkMode_RadioButton.isSelected()){
            ...
            ingameScreenController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobal)));
            ingameScreenController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobalDark, "/de/uniks/pioneers/styles/DarkMode_IngameScreen.css");
            ...
            newGameController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobal)));
            newGameController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobalDark, "/de/uniks/pioneers/styles/DarkMode_NewGameScreen.css");
            ...
            lobbyController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobal)));
            lobbyController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobalDark, "/de/uniks/pioneers/styles/DarkMode_LobbyScreen.css");
            chatController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobal)));
            chatController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobalDark);
            ...
            editController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobal)));
            editController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobalDark, "/de/uniks/pioneers/styles/DarkMode_EditProfileScreen.css");
            loginController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobal)));
            loginController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobalDark);
            ...
            rulesController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobal)));
            rulesController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobalDark, "/de/uniks/pioneers/styles/DarkMode_RulesScreen.css");
            ...
            userListController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobal)));
            userListController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobalDark, "/de/uniks/pioneers/styles/DarkMode_UserListView.css");
            gameListController.getApp().getStage().getScene().getStylesheets().removeIf((style -> style.equals(styleGlobal)));
            gameListController.getApp().getStage().getScene().getStylesheets().addAll(styleGlobalDark);
            stage.getScene().getStylesheets().removeIf((style -> style.equals("/de/uniks/pioneers/styles/SettingsScreen.css")));
            stage.getScene().getStylesheets().removeIf((style -> style.equals(styleGlobal)));
            stage.getScene().getStylesheets().addAll(styleGlobalDark, "/de/uniks/pioneers/styles/DarkMode_SettingsScreen.css");
        }
    }
